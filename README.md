...
- Next highest-value step: audit branch-consumer ternary cleanup where second-stage wrapper helpers mix direct returns
  with local-chain returns before final return.
