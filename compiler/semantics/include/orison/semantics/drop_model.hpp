...
enum class SemanticOwnedCleanupLoweringGate {
    disabled,
    enabled,
};
...
auto authorize_owned_cleanup_lowering(
    OwnedCleanupSite site,
    std::vector<OwnedCleanupImplementation> const& implementations,
    SemanticOwnedCleanupLoweringGate semantic_owned_cleanup_lowering_gate = SemanticOwnedCleanupLoweringGate::disabled
