...
BranchBindingScope::BranchBindingScope(FunctionLoweringState& state)
    : state_(state),
      ...
      saved_consumed_owned_dynamic_array_locals_(state.consumed_owned_dynamic_array_locals) {}
...
BranchBindingScope::~BranchBindingScope() noexcept {
    ...
    state_.consumed_owned_dynamic_array_locals.swap(saved_consumed_owned_dynamic_array_locals_);
}
...
void BranchBindingScope::reset() {
    ...
    state_.consumed_owned_dynamic_array_locals = saved_consumed_owned_dynamic_array_locals_;
}
