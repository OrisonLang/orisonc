...
struct LlvmIrEmissionResult {
    ...
    std::vector<std::string> fixture_dynamic_array_allocation_call_ir;
    std::vector<std::string> fixture_dynamic_array_grow_call_ir;
    std::vector<std::string> fixture_dynamic_array_deallocation_call_ir;
    std::vector<std::string> fixture_dynamic_array_descriptor_binding_ir;
    std::vector<std::string> fixture_dynamic_array_descriptor_projection_ir;
    std::vector<std::string> fixture_dynamic_array_bounds_check_ir;
    std::vector<std::string> fixture_dynamic_array_element_address_ir;
    std::vector<std::string> fixture_dynamic_array_element_load_ir;
    std::vector<std::string> fixture_dynamic_array_element_store_ir;
    std::vector<std::string> fixture_dynamic_array_descriptor_length_update_ir;
    std::vector<std::string> fixture_dynamic_array_descriptor_write_back_ir;
    std::vector<std::string> fixture_dynamic_array_append_sequence_ir;
    std::vector<std::string> fixture_dynamic_array_grow_sequence_ir;
    std::vector<std::string> fixture_dynamic_array_append_with_grow_sequence_ir;
    std::vector<std::string> fixture_dynamic_array_cleanup_sequence_ir;
    std::vector<std::string> fixture_dynamic_array_descriptor_load_cleanup_sequence_ir;
    std::vector<std::string> fixture_dynamic_array_element_owned_cleanup_walk_ir;
