...
auto main() -> int {
    ...
    assert(!dynamic_array_switch_returned_aggregate_field_owned_computed_for_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_returned_aggregate_field_owned_computed_for_cleanup_ir,
        "returned.values"
    );
    assert_dynamic_array_payload_cleanup_ready(dynamic_array_switch_returned_aggregate_field_owned_computed_for_cleanup_ir);
    assert_ir_contains(
    ...
    assert_emit_object_link_run_success(
        pipeline,
        dynamic_array_switch_returned_aggregate_field_owned_computed_for_cleanup_path,
        smoke_temp_root / "dynamic_array_switch_returned_aggregate_field_owned_computed_for_cleanup_run"
    );
    auto dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_run.or";
    auto dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_ir,
        "returned.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_ir
    ...
    auto dynamic_array_branch_returned_aggregate_field_owned_computed_for_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_branch_returned_aggregate_field_owned_computed_for_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_branch_returned_aggregate_field_owned_computed_for_cleanup_ir,
        "returned.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_branch_returned_aggregate_field_owned_computed_for_cleanup_ir
    ...
    assert_emit_object_link_run_success(
        pipeline,
        dynamic_array_branch_returned_aggregate_field_owned_computed_for_cleanup_path,
        smoke_temp_root / "dynamic_array_branch_returned_aggregate_field_owned_computed_for_cleanup_run"
    );
    auto dynamic_array_branch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_branch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_run.or";
    auto dynamic_array_branch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_branch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_branch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_ir,
        "returned.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_branch_forwarded_returned_aggregate_field_owned_computed_for_cleanup_ir
    ...
    assert(!dynamic_array_returned_aggregate_field_final_if_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_returned_aggregate_field_final_if_branch_local_cleanup_ir,
        "returned.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_returned_aggregate_field_final_if_branch_local_cleanup_ir
    ...
    auto dynamic_array_switch_returned_aggregate_field_final_if_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_switch_returned_aggregate_field_final_if_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_returned_aggregate_field_final_if_branch_local_cleanup_ir,
        "returned.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_switch_returned_aggregate_field_final_if_branch_local_cleanup_ir
    ...
    auto dynamic_array_switch_forwarded_returned_aggregate_field_final_if_branch_local_cleanup_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_forwarded_returned_aggregate_field_final_if_branch_local_cleanup_run.or";
    auto dynamic_array_switch_forwarded_returned_aggregate_field_final_if_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_switch_forwarded_returned_aggregate_field_final_if_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_forwarded_returned_aggregate_field_final_if_branch_local_cleanup_ir,
        "returned.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_switch_forwarded_returned_aggregate_field_final_if_branch_local_cleanup_ir
    ...
    auto dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_if_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_if_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_if_branch_local_cleanup_ir,
        "returned.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_if_branch_local_cleanup_ir
    ...
    assert(!dynamic_array_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir,
    ...
    auto dynamic_array_switch_returned_nested_aggregate_field_final_if_branch_local_cleanup_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_returned_nested_aggregate_field_final_if_branch_local_cleanup_run.or";
    auto dynamic_array_switch_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_switch_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_switch_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir
    ...
    auto dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir
    ...
    assert_ir_contains(
        dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir.ir_text,
        "call %record.OuterBox @forward_outer(%record.OuterBox %tmp"
    );
    assert_ir_contains(
        dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir.ir_text,
        "phi %record.OuterBox"
    ...
    auto dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir
    ...
    auto dynamic_array_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_forwarded_returned_nested_aggregate_field_final_if_branch_local_cleanup_ir
    ...
    auto dynamic_array_switch_returned_aggregate_field_final_switch_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_switch_returned_aggregate_field_final_switch_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_returned_aggregate_field_final_switch_branch_local_cleanup_ir,
        "returned.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_switch_returned_aggregate_field_final_switch_branch_local_cleanup_ir
    ...
    auto dynamic_array_switch_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_run.or";
    auto dynamic_array_switch_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_switch_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_ir,
        "returned.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_switch_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_ir
    ...
    auto dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_run.or";
    auto dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_ir,
        "returned.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_switch_branch_local_cleanup_ir
    ...
    auto dynamic_array_switch_returned_nested_aggregate_field_final_switch_branch_local_cleanup_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_returned_nested_aggregate_field_final_switch_branch_local_cleanup_run.or";
    auto dynamic_array_switch_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_switch_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_switch_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir
    ...
    auto dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir
    ...
    auto dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir
    ...
    auto dynamic_array_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_forwarded_returned_nested_aggregate_field_final_switch_branch_local_cleanup_ir
    ...
    auto dynamic_array_switch_returned_nested_aggregate_field_owned_computed_for_cleanup_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_returned_nested_aggregate_field_owned_computed_for_cleanup_run.or";
    ...
    assert(!dynamic_array_switch_returned_nested_aggregate_field_owned_computed_for_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_returned_nested_aggregate_field_owned_computed_for_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_switch_returned_nested_aggregate_field_owned_computed_for_cleanup_ir
    ...
    assert_emit_object_link_run_success(
        pipeline,
        dynamic_array_switch_returned_nested_aggregate_field_owned_computed_for_cleanup_path,
        smoke_temp_root / "dynamic_array_switch_returned_nested_aggregate_field_owned_computed_for_cleanup_run"
    );
    auto dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_run.or";
    auto dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir
    ...
    auto dynamic_array_branch_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_branch_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_branch_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_branch_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir
    ...
    auto dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir =
        pipeline.emit_llvm(
    ...
    assert(!dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir.has_errors());
    assert_dynamic_array_payload_returned_lifetime_owner(
        dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir,
        "returned.inner.values"
    );
    assert_dynamic_array_payload_cleanup_ready(
        dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_owned_computed_for_cleanup_ir
    ...
    auto dynamic_array_switch_returned_aggregate_field_owned_computed_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_returned_aggregate_field_owned_computed_reuse_rejected.or";
    auto dynamic_array_switch_returned_aggregate_field_owned_computed_reuse_ir =
        pipeline.emit_llvm(dynamic_array_switch_returned_aggregate_field_owned_computed_reuse_path);
    assert(dynamic_array_switch_returned_aggregate_field_owned_computed_reuse_ir.has_errors());
    assert(
        dynamic_array_switch_returned_aggregate_field_owned_computed_reuse_ir.error_text.find(
            "use after move: returned.values"
        ) != std::string::npos
    );
    auto dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_reuse_rejected.or";
    auto dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_reuse_ir =
        pipeline.emit_llvm(dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_reuse_path);
    assert(dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_reuse_ir.has_errors());
    assert(
        dynamic_array_switch_forwarded_returned_aggregate_field_owned_computed_reuse_ir.error_text.find(
            "use after move: returned.values"
        ) != std::string::npos
    );
    auto dynamic_array_branch_returned_aggregate_field_owned_computed_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_branch_returned_aggregate_field_owned_computed_reuse_rejected.or";
    auto dynamic_array_branch_returned_aggregate_field_owned_computed_reuse_ir =
        pipeline.emit_llvm(dynamic_array_branch_returned_aggregate_field_owned_computed_reuse_path);
    assert(dynamic_array_branch_returned_aggregate_field_owned_computed_reuse_ir.has_errors());
    assert(
        dynamic_array_branch_returned_aggregate_field_owned_computed_reuse_ir.error_text.find(
            "use after move: returned.values"
        ) != std::string::npos
    );
    auto dynamic_array_branch_forwarded_returned_aggregate_field_owned_computed_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_branch_forwarded_returned_aggregate_field_owned_computed_reuse_rejected.or";
    auto dynamic_array_branch_forwarded_returned_aggregate_field_owned_computed_reuse_ir =
        pipeline.emit_llvm(dynamic_array_branch_forwarded_returned_aggregate_field_owned_computed_reuse_path);
    ...
    auto dynamic_array_switch_returned_nested_aggregate_field_owned_computed_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_returned_nested_aggregate_field_owned_computed_reuse_rejected.or";
    auto dynamic_array_switch_returned_nested_aggregate_field_owned_computed_reuse_ir =
        pipeline.emit_llvm(dynamic_array_switch_returned_nested_aggregate_field_owned_computed_reuse_path);
    assert(dynamic_array_switch_returned_nested_aggregate_field_owned_computed_reuse_ir.has_errors());
    assert(
        dynamic_array_switch_returned_nested_aggregate_field_owned_computed_reuse_ir.error_text.find(
            "use after move: returned.inner.values"
        ) != std::string::npos
    );
    auto dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_reuse_rejected.or";
    auto dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_reuse_ir =
        pipeline.emit_llvm(dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_reuse_path);
    assert(dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_reuse_ir.has_errors());
    assert(
        dynamic_array_switch_forwarded_returned_nested_aggregate_field_owned_computed_reuse_ir.error_text.find(
            "use after move: returned.inner.values"
        ) != std::string::npos
    );
    ...
    auto dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_owned_computed_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_owned_computed_reuse_rejected.or";
    auto dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_owned_computed_reuse_ir =
        pipeline.emit_llvm(dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_owned_computed_reuse_path);
    assert(dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_owned_computed_reuse_ir.has_errors());
    assert(
        dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_owned_computed_reuse_ir.error_text.find(
            "use after move: returned.inner.values"
        ) != std::string::npos
    );
    ...
    auto dynamic_array_returned_aggregate_field_final_if_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_returned_aggregate_field_final_if_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_returned_aggregate_field_final_if_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    auto dynamic_array_switch_returned_aggregate_field_final_if_branch_local_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_returned_aggregate_field_final_if_branch_local_reuse_rejected.or";
    auto dynamic_array_switch_returned_aggregate_field_final_if_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_switch_returned_aggregate_field_final_if_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_switch_returned_aggregate_field_final_if_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    auto dynamic_array_switch_forwarded_returned_aggregate_field_final_if_branch_local_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_forwarded_returned_aggregate_field_final_if_branch_local_reuse_rejected.or";
    auto dynamic_array_switch_forwarded_returned_aggregate_field_final_if_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_switch_forwarded_returned_aggregate_field_final_if_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_switch_forwarded_returned_aggregate_field_final_if_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    ...
    auto dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_if_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_if_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_if_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    ...
    auto dynamic_array_switch_returned_nested_aggregate_field_final_if_branch_local_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_returned_nested_aggregate_field_final_if_branch_local_reuse_rejected.or";
    auto dynamic_array_switch_returned_nested_aggregate_field_final_if_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_switch_returned_nested_aggregate_field_final_if_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_switch_returned_nested_aggregate_field_final_if_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    auto dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_if_branch_local_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_if_branch_local_reuse_rejected.or";
    auto dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_if_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_if_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_if_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    auto dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_if_branch_local_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_if_branch_local_reuse_rejected.or";
    auto dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_if_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_if_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_if_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    auto dynamic_array_forwarded_returned_nested_aggregate_field_final_if_owner_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_forwarded_returned_nested_aggregate_field_final_if_owner_reuse_rejected.or";
    auto dynamic_array_forwarded_returned_nested_aggregate_field_final_if_owner_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_forwarded_returned_nested_aggregate_field_final_if_owner_reuse_ir.has_errors());
    assert(
        dynamic_array_forwarded_returned_nested_aggregate_field_final_if_owner_reuse_ir.error_text.find(
            "use after move: returned.inner.values"
        ) != std::string::npos
    );
    ...
    auto dynamic_array_switch_returned_aggregate_field_final_switch_branch_local_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_returned_aggregate_field_final_switch_branch_local_reuse_rejected.or";
    auto dynamic_array_switch_returned_aggregate_field_final_switch_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_switch_returned_aggregate_field_final_switch_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_switch_returned_aggregate_field_final_switch_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    auto dynamic_array_switch_forwarded_returned_aggregate_field_final_switch_branch_local_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_forwarded_returned_aggregate_field_final_switch_branch_local_reuse_rejected.or";
    auto dynamic_array_switch_forwarded_returned_aggregate_field_final_switch_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    auto dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_switch_branch_local_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_switch_branch_local_reuse_rejected.or";
    auto dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_switch_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_switch_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_branch_mixed_forwarded_returned_aggregate_field_final_switch_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    ...
    auto dynamic_array_switch_returned_nested_aggregate_field_final_switch_branch_local_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_returned_nested_aggregate_field_final_switch_branch_local_reuse_rejected.or";
    auto dynamic_array_switch_returned_nested_aggregate_field_final_switch_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_switch_returned_nested_aggregate_field_final_switch_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_switch_returned_nested_aggregate_field_final_switch_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    auto dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_switch_branch_local_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_switch_branch_local_reuse_rejected.or";
    auto dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_switch_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_switch_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_switch_forwarded_returned_nested_aggregate_field_final_switch_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    auto dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_switch_branch_local_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_switch_branch_local_reuse_rejected.or";
    auto dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_switch_branch_local_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_switch_branch_local_reuse_ir.has_errors());
    assert(
        dynamic_array_branch_mixed_forwarded_returned_nested_aggregate_field_final_switch_branch_local_reuse_ir.error_text.find(
            "use after move: scratch"
        ) != std::string::npos
    );
    auto dynamic_array_forwarded_returned_nested_aggregate_field_final_switch_owner_reuse_path =
        std::filesystem::path(ORISON_SOURCE_DIR) / "tests" / "fixtures" /
        "dynamic_array_forwarded_returned_nested_aggregate_field_final_switch_owner_reuse_rejected.or";
    auto dynamic_array_forwarded_returned_nested_aggregate_field_final_switch_owner_reuse_ir =
        pipeline.emit_llvm(
    ...
    assert(dynamic_array_forwarded_returned_nested_aggregate_field_final_switch_owner_reuse_ir.has_errors());
    assert(
