...
auto main() -> int {
    ...
    assert(runtime_indexed_cleanup.runtime_indexed_cleanup_audit_lines.size() == 15);
    assert(
    ...
    assert(
        ...
        "production-member-cleanup disabled prerequisites missing production disabled blockers 3 "
