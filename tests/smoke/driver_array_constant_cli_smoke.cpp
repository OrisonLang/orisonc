...
auto main() -> int {
    ...
    auto smoke_temp_root = original_temp_root /
        ("orison_driver_array_constant_cli_smoke_" + std::to_string(static_cast<long long>(::getpid())));
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_array_constant_element.or",
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_array_constant_length.or",
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_nested_array_constant_element.or",
        nested_array_constant_lines(nested_array_constant_initializer("[1, true]")),
        "constant array initializer element type 'Bool' does not match declared element type 'UInt32'"
    );
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_nested_array_constant_length.or",
        nested_array_constant_lines(nested_array_constant_initializer("[1, 2, 3]")),
        "constant array initializer length 3 does not match declared length 2"
    );
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_indexed_array_constant_element_type.or",
        std::vector<std::string_view> {
            "package demo.cli",
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_array_constant_unknown_reference.or",
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_array_constant_direct_cycle.or",
        scalar_array_constant_lines(scalar_array_constant_initializer("MAGIC[0]")),
        "constant initializer cycle includes 'MAGIC'"
    );
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_address_array_constant_element.or",
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_pointer_array_constant_construction.or",
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_nested_choice_array_constant_payload.or",
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_choice_constant_array_payload_length.or",
        maybe_choice_constant_lines("const DEFAULT_VALUE: Maybe<Array<UInt32, 2>> = Some([1, 2, 3])"),
        "constant array initializer length 3 does not match declared length 2"
    );
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_array_constant_function_call.or",
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_choice_array_payload_function_call.or",
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_array_constant_unsafe_intrinsic.or",
        scalar_array_constant_lines(
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_choice_array_payload_unsafe_intrinsic.or",
        maybe_choice_constant_lines(
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_array_constant_await.or",
        scalar_array_constant_lines(
    ...
    assert_cli_parse_failure(
        executable,
        smoke_temp_root / "orison_cli_choice_array_payload_await.or",
        maybe_choice_constant_lines(
