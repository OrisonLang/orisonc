...
auto main() -> int {
    ...
    constexpr auto backend_demos = std::array<PipelineDemo, 8> {
        ...
        PipelineDemo {"local_null_safe_generic_aggregate.or", "call %record.Box_UInt32_ @method.Box_UInt32_.bump"},
