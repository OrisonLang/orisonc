...
auto main() -> int {
    ...
    write_fixture(
        ...
        "demo.run",
        {
            ...
            "    return final_present_score() + return_present_score() + final_empty_score() + return_nested_absent_score() + final_record_payload_score() + return_record_payload_score() + final_member_call_score() + final_nested_member_call_score() + final_nested_absent_member_call_score() + return_empty_member_call_score() - 58 as UInt32",
        }
    );
