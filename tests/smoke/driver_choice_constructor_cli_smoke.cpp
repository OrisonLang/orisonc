...
auto main() -> int {
    ...
    auto consumed_choice_payload_parameter_reuse_lines = std::vector<std::string_view> {
        ...
        "    1 as UInt32",
        "function main(holder: Holder) -> UInt32",
        "    switch holder",
        "        Loaded(payload) =>",
    ...
    assert_cli_emit_llvm_failure(
        executable,
        smoke_temp_root / "orison_cli_consumed_choice_payload_parameter_reuse.or",
        consumed_choice_payload_parameter_reuse_lines,
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_if_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_if_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_guard_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_guard_assignment",
    ...
    auto sourced_scalar_choice_maybe_record_nested_array_guard_assignment_alt_index_lines = std::vector<std::string_view> {
        "package demo.cli",
        "choice LocalStatus",
        "    Ready(code: UInt32)",
        "    Empty",
        ...
        "    var maybe_grid: Maybe<StatusGrid> = Empty",
        "    guard false else",
        "        maybe_grid = Some(StatusGrid([[Empty, Empty], [Ready(263 as UInt32), Empty]]))",
        "        return observe(maybe_grid)",
        "    3 as UInt32",
    };
    assert_cli_emit_llvm_and_run_success(
    ...
    auto sourced_scalar_choice_maybe_record_maybe_nested_array_guard_assignment_alt_index_lines = std::vector<std::string_view> {
        ...
        "    var maybe_grid: Maybe<StatusGrid> = Empty",
        "    guard false else",
        "        maybe_grid = Some(StatusGrid([[Empty, Empty], [Some(Ready(265 as UInt32)), Empty]]))",
        "        return observe(maybe_grid)",
        "    4 as UInt32",
    };
    assert_cli_emit_llvm_and_run_success(
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_switch_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_switch_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_if_element_assignment_alt_index",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_if_element_assignment_alt_index",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_switch_element_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_switch_element_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_switch_element_assignment_alt_index",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_switch_element_assignment_alt_index",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_while_element_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_while_element_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_while_element_assignment_alt_index",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_while_element_assignment_alt_index",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_repeat_element_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_repeat_element_assignment",
    ...
    auto sourced_scalar_choice_maybe_record_nested_array_repeat_element_assignment_alt_index_lines = std::vector<std::string_view> {
        "package demo.cli",
        "choice LocalStatus",
        "    Ready(code: UInt32)",
        "    Empty",
        ...
        "    var slots: GridSlots = GridSlots([Empty, Empty])",
        "    repeat",
        "        slots.grids[0 as UInt64] = Some(StatusGrid([[Empty, Empty], [Ready(317 as UInt32), Empty]]))",
        "    while false",
        "    switch slots.grids[0 as UInt64]",
        "        Some(grid) =>",
        "            switch grid.statuses[1 as UInt64][0 as UInt64]",
        "                Ready(code) => code - 317 as UInt32",
        "                Empty => 1 as UInt32",
        "        Empty => 2 as UInt32",
    };
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_repeat_element_assignment_alt_index",
        sourced_scalar_choice_maybe_record_nested_array_repeat_element_assignment_alt_index_lines,
        {
            "%record.StatusGrid = type { [2 x [2 x { i32, i32 }]] }",
            "%record.GridSlots = type { [2 x { i1, %record.StatusGrid }] }",
            "alloca %record.GridSlots",
    ...
    auto sourced_scalar_choice_maybe_record_maybe_nested_array_repeat_element_assignment_alt_index_lines = std::vector<std::string_view> {
        "package demo.cli",
        "choice LocalStatus",
        "    Ready(code: UInt32)",
        "    Empty",
        ...
        "    var slots: GridSlots = GridSlots([Empty, Empty])",
        "    repeat",
        "        slots.grids[0 as UInt64] = Some(StatusGrid([[Empty, Empty], [Some(Ready(319 as UInt32)), Empty]]))",
        "    while false",
        "    switch slots.grids[0 as UInt64]",
        "        Some(grid) =>",
        "            switch grid.statuses[1 as UInt64][0 as UInt64]",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_repeat_element_assignment_alt_index",
        sourced_scalar_choice_maybe_record_maybe_nested_array_repeat_element_assignment_alt_index_lines,
        {
            "%record.StatusGrid = type { [2 x [2 x { i1, { i32, i32 } }]] }",
            "%record.GridSlots = type { [2 x { i1, %record.StatusGrid }] }",
            "alloca %record.GridSlots",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_for_element_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_for_element_assignment",
    ...
    auto sourced_scalar_choice_maybe_record_nested_array_for_element_assignment_alt_index_lines = std::vector<std::string_view> {
        "package demo.cli",
        "choice LocalStatus",
        "    Ready(code: UInt32)",
        "    Empty",
        ...
        "    var slots: GridSlots = GridSlots([Empty, Empty])",
        "    for item in [0 as UInt32]",
        "        slots.grids[0 as UInt64] = Some(StatusGrid([[Empty, Empty], [Ready(321 as UInt32), Empty]]))",
        "    switch slots.grids[0 as UInt64]",
        "        Some(grid) =>",
        "            switch grid.statuses[1 as UInt64][0 as UInt64]",
        "                Ready(code) => code - 321 as UInt32",
        "                Empty => 1 as UInt32",
        "        Empty => 2 as UInt32",
    };
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_for_element_assignment_alt_index",
        sourced_scalar_choice_maybe_record_nested_array_for_element_assignment_alt_index_lines,
        {
            "%record.StatusGrid = type { [2 x [2 x { i32, i32 }]] }",
            "%record.GridSlots = type { [2 x { i1, %record.StatusGrid }] }",
            "alloca %record.GridSlots",
    ...
    auto sourced_scalar_choice_maybe_record_maybe_nested_array_for_element_assignment_alt_index_lines = std::vector<std::string_view> {
        "package demo.cli",
        "choice LocalStatus",
        "    Ready(code: UInt32)",
        "    Empty",
        ...
        "    var slots: GridSlots = GridSlots([Empty, Empty])",
        "    for item in [0 as UInt32]",
        "        slots.grids[0 as UInt64] = Some(StatusGrid([[Empty, Empty], [Some(Ready(323 as UInt32)), Empty]]))",
        "    switch slots.grids[0 as UInt64]",
        "        Some(grid) =>",
        "            switch grid.statuses[1 as UInt64][0 as UInt64]",
        "                Some(status) =>",
        "                    switch status",
        "                        Ready(code) => code - 323 as UInt32",
        "                        Empty => 1 as UInt32",
        "                Empty => 2 as UInt32",
        "        Empty => 3 as UInt32",
    };
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_for_element_assignment_alt_index",
        sourced_scalar_choice_maybe_record_maybe_nested_array_for_element_assignment_alt_index_lines,
        {
            "%record.StatusGrid = type { [2 x [2 x { i1, { i32, i32 } }]] }",
            "%record.GridSlots = type { [2 x { i1, %record.StatusGrid }] }",
            "alloca %record.GridSlots",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_unsafe_element_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_unsafe_element_assignment",
    ...
    auto sourced_scalar_choice_maybe_record_nested_array_unsafe_element_assignment_alt_index_lines = std::vector<std::string_view> {
        "package demo.cli",
        "choice LocalStatus",
        "    Ready(code: UInt32)",
        "    Empty",
        ...
        "    var slots: GridSlots = GridSlots([Empty, Empty])",
        "    unsafe",
        "        slots.grids[0 as UInt64] = Some(StatusGrid([[Empty, Empty], [Ready(325 as UInt32), Empty]]))",
        "    switch slots.grids[0 as UInt64]",
        "        Some(grid) =>",
        "            switch grid.statuses[1 as UInt64][0 as UInt64]",
        "                Ready(code) => code - 325 as UInt32",
        "                Empty => 1 as UInt32",
        "        Empty => 2 as UInt32",
    };
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_unsafe_element_assignment_alt_index",
        sourced_scalar_choice_maybe_record_nested_array_unsafe_element_assignment_alt_index_lines,
        {
            "%record.StatusGrid = type { [2 x [2 x { i32, i32 }]] }",
            "%record.GridSlots = type { [2 x { i1, %record.StatusGrid }] }",
            "alloca %record.GridSlots",
    ...
    auto sourced_scalar_choice_maybe_record_maybe_nested_array_unsafe_element_assignment_alt_index_lines = std::vector<std::string_view> {
        "package demo.cli",
        "choice LocalStatus",
        "    Ready(code: UInt32)",
        "    Empty",
        ...
        "    var slots: GridSlots = GridSlots([Empty, Empty])",
        "    unsafe",
        "        slots.grids[0 as UInt64] = Some(StatusGrid([[Empty, Empty], [Some(Ready(327 as UInt32)), Empty]]))",
        "    switch slots.grids[0 as UInt64]",
        "        Some(grid) =>",
        "            switch grid.statuses[1 as UInt64][0 as UInt64]",
        "                Some(status) =>",
        "                    switch status",
        "                        Ready(code) => code - 327 as UInt32",
        "                        Empty => 1 as UInt32",
        "                Empty => 2 as UInt32",
        "        Empty => 3 as UInt32",
    };
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_unsafe_element_assignment_alt_index",
        sourced_scalar_choice_maybe_record_maybe_nested_array_unsafe_element_assignment_alt_index_lines,
        {
            "%record.StatusGrid = type { [2 x [2 x { i1, { i32, i32 } }]] }",
            "%record.GridSlots = type { [2 x { i1, %record.StatusGrid }] }",
            "alloca %record.GridSlots",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_guard_element_assignment",
    ...
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_guard_element_assignment",
    ...
    auto sourced_scalar_choice_maybe_record_nested_array_guard_element_assignment_alt_index_lines = std::vector<std::string_view> {
        "package demo.cli",
        "choice LocalStatus",
        "    Ready(code: UInt32)",
        "    Empty",
        ...
        "        Some(grid) =>",
        "            switch grid.statuses[1 as UInt64][0 as UInt64]",
        "                Ready(code) => code - 329 as UInt32",
        "                Empty => 1 as UInt32",
        "        Empty => 2 as UInt32",
        "function main() -> UInt32",
        "    var slots: GridSlots = GridSlots([Empty, Empty])",
        "    guard false else",
        "        slots.grids[0 as UInt64] = Some(StatusGrid([[Empty, Empty], [Ready(329 as UInt32), Empty]]))",
        "        return observe(slots)",
        "    3 as UInt32",
    };
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_nested_array_guard_element_assignment_alt_index",
        sourced_scalar_choice_maybe_record_nested_array_guard_element_assignment_alt_index_lines,
        {
            "define i32 @observe(%record.GridSlots %slots)",
            "%record.StatusGrid = type { [2 x [2 x { i32, i32 }]] }",
            "%record.GridSlots = type { [2 x { i1, %record.StatusGrid }] }",
    ...
    auto sourced_scalar_choice_maybe_record_maybe_nested_array_guard_element_assignment_alt_index_lines = std::vector<std::string_view> {
        "package demo.cli",
        "choice LocalStatus",
        "    Ready(code: UInt32)",
        "    Empty",
        ...
        "    var slots: GridSlots = GridSlots([Empty, Empty])",
        "    guard false else",
        "        slots.grids[0 as UInt64] = Some(StatusGrid([[Empty, Empty], [Some(Ready(331 as UInt32)), Empty]]))",
        "        return observe(slots)",
        "    4 as UInt32",
    };
    assert_cli_emit_llvm_and_run_success(
        executable,
        smoke_temp_root,
        "orison_cli_sourced_scalar_choice_maybe_record_maybe_nested_array_guard_element_assignment_alt_index",
        sourced_scalar_choice_maybe_record_maybe_nested_array_guard_element_assignment_alt_index_lines,
        {
            "define i32 @observe(%record.GridSlots %slots)",
            "%record.StatusGrid = type { [2 x [2 x { i1, { i32, i32 } }]] }",
            "%record.GridSlots = type { [2 x { i1, %record.StatusGrid }] }",
    ...
    assert_cli_emit_llvm_success(
        executable,
        smoke_temp_root / "orison_cli_generic_distinct_record_payload_choice_emit.or",
        std::vector<std::string_view> {
            "package demo.cli",
            "record Payload",
            "    code: UInt32",
            ...
            "    Ok(value: T)",
            "    Error(error: E)",
            "function make_result() -> Result<Payload, Flag>",
            "    Ok(Payload(7 as UInt32))",
        },
        {
            "%record.Payload = type { i32 }",
            "%record.Flag = type { i1 }",
