...
auto box_maybe_items_assignment_fixture_lines(std::string_view assignment_line) -> std::vector<std::string> {
    return {
        "choice Maybe<T>",
        "    Some(value: T)",
        "    Empty",
...
auto slot_pointer_items_assignment_fixture_lines(std::string_view assignment_line) -> std::vector<std::string> {
    return {
        "record Slot<T>",
        "    ptr: Pointer<T>",
        "choice Wrap<T>",
...
auto slot_pointer_items_assignment_success_fixture_lines(std::string_view assignment_line)
    -> std::vector<std::string> {
    auto lines = slot_pointer_items_assignment_fixture_lines(assignment_line);
    lines[4] = "unsafe function demo(flag: Bool, base: Pointer<UInt32>, other: Pointer<UInt32>) -> UInt32";
    return lines;
}

auto box_maybe_holder_items_assignment_fixture_lines(std::string_view assignment_line) -> std::vector<std::string> {
    return {
        "choice Maybe<T>",
        "    Some(value: T)",
        "    Empty",
...
auto slot_pointer_holder_items_assignment_fixture_lines(std::string_view assignment_line) -> std::vector<std::string> {
    return {
        "record Slot<T>",
        "    ptr: Pointer<T>",
        "choice Wrap<T>",
...
auto slot_pointer_holder_items_assignment_success_fixture_lines(std::string_view assignment_line)
    -> std::vector<std::string> {
    auto lines = slot_pointer_holder_items_assignment_fixture_lines(assignment_line);
    lines[6] = "unsafe function demo(flag: Bool, base: Pointer<UInt32>, other: Pointer<UInt32>) -> UInt32";
    return lines;
}
...
auto box_maybe_items_final_if_fixture_lines(std::string_view true_branch) -> std::vector<std::string> {
    return {
        "choice Maybe<T>",
        "    Some(value: T)",
        "    Empty",
...
auto slot_pointer_items_final_if_fixture_lines(std::string_view true_branch) -> std::vector<std::string> {
    return {
        "record Slot<T>",
        "    ptr: Pointer<T>",
        "choice Wrap<T>",
...
auto slot_pointer_items_final_if_success_fixture_lines(std::string_view true_branch) -> std::vector<std::string> {
    auto lines = slot_pointer_items_final_if_fixture_lines(true_branch);
    lines[4] = "unsafe function demo(flag: Bool, base: Pointer<UInt32>, other: Pointer<UInt32>) -> Wrap<UInt32>";
    return lines;
}

auto box_maybe_holder_items_return_fixture_lines(std::string_view return_line) -> std::vector<std::string> {
    return {
        "choice Maybe<T>",
        "    Some(value: T)",
        "    Empty",
...
auto slot_pointer_holder_items_return_fixture_lines(std::string_view return_line) -> std::vector<std::string> {
    return {
        "record Slot<T>",
        "    ptr: Pointer<T>",
        "choice Wrap<T>",
...
auto slot_pointer_holder_items_return_success_fixture_lines(std::string_view return_line) -> std::vector<std::string> {
    auto lines = slot_pointer_holder_items_return_fixture_lines(return_line);
...
void test_pointer_record_unknown_member_failure() {
    ...
    assert_member_access_unknown_member_diagnostic(path, 5, "Pointer<Registers>", "missing");
}

void test_pointer_record_scalar_member_continuation_failure() {
    auto path =
        std::filesystem::temp_directory_path() / "orison_semantics_pointer_record_scalar_member_continuation.or";
    write_concurrency_fixture(
        path,
        "demo.records",
        {
...
void test_null_safe_record_unknown_member_failure() {
    auto path = std::filesystem::temp_directory_path() / "orison_semantics_null_safe_record_unknown_member.or";
    write_concurrency_fixture(
        path,
        "demo.records",
        {
...
void test_null_safe_concrete_generic_scalar_member_continuation_failure() {
    auto path = std::filesystem::temp_directory_path() /
        "orison_semantics_null_safe_concrete_generic_scalar_member_continuation.or";
    write_concurrency_fixture(
        path,
        "demo.records",
        {
    ...
    assert_member_access_unknown_member_diagnostic(path, 9, "UInt32", "missing");
}

void test_null_safe_concrete_generic_unknown_method_failure() {
    auto path =
        std::filesystem::temp_directory_path() / "orison_semantics_null_safe_concrete_generic_unknown_method.or";
    write_concurrency_fixture(
        path,
        "demo.records",
        {
    ...
    assert_fixture_single_diagnostic(path, 9, "type 'Box<UInt32>' has no method 'missing'");
}

void test_null_safe_concrete_generic_scalar_unknown_method_failure() {
    auto path = std::filesystem::temp_directory_path() /
        "orison_semantics_null_safe_concrete_generic_scalar_unknown_method.or";
    write_concurrency_fixture(
        path,
        "demo.records",
        {
...
void test_null_safe_concrete_generic_method_success() {
    auto path =
        std::filesystem::temp_directory_path() / "orison_semantics_null_safe_concrete_generic_method_success.or";
    write_concurrency_fixture(
        path,
        "demo.records",
        {
...
void test_null_safe_concrete_generic_aggregate_method_ordinary_field_failure() {
    auto path = std::filesystem::temp_directory_path() /
        "orison_semantics_null_safe_concrete_generic_aggregate_method_ordinary_field_failure.or";
    write_concurrency_fixture(
        path,
        "demo.records",
        {
...
void test_assignment_choice_payload_nested_array_record_constructor_choice_ternary_field_failure() {
    assert_record_field_nested_array_choice_context_failure(
        "orison_semantics_assignment_choice_payload_nested_array_record_choice_ternary_field_failure.or",
        box_maybe_items_assignment_fixture_lines(
...
void test_assignment_choice_payload_nested_array_record_constructor_choice_ternary_field_success() {
    assert_record_field_nested_array_context_success(
        "orison_semantics_assignment_choice_payload_nested_array_record_choice_ternary_field_success.or",
        box_maybe_items_assignment_fixture_lines(
...
void test_assignment_choice_payload_nested_array_record_constructor_pointer_ternary_field_failure() {
    assert_record_field_nested_array_pointer_context_failure(
        "orison_semantics_assignment_choice_payload_nested_array_record_pointer_ternary_field_failure.or",
        slot_pointer_items_assignment_fixture_lines(
...
void test_assignment_choice_payload_nested_array_record_constructor_pointer_ternary_field_success() {
    assert_record_field_nested_array_context_success(
...
void test_final_if_choice_payload_nested_array_record_constructor_choice_ternary_field_failure() {
    assert_record_field_nested_array_choice_context_failure(
        "orison_semantics_final_if_choice_payload_nested_array_record_choice_ternary_field_failure.or",
        box_maybe_items_final_if_fixture_lines(
            "        Items([[Box(flag ? Some(true) : Empty)]])"
        ),
        11
    );
...
void test_final_if_choice_payload_nested_array_record_constructor_choice_ternary_field_success() {
    assert_record_field_nested_array_context_success(
        "orison_semantics_final_if_choice_payload_nested_array_record_choice_ternary_field_success.or",
        box_maybe_items_final_if_fixture_lines(
            "        Items([[Box(flag ? Some(1 as UInt32) : Empty)]])"
        )
    );
...
void test_final_if_choice_payload_nested_array_record_constructor_pointer_ternary_field_failure() {
    assert_record_field_nested_array_pointer_context_failure(
        "orison_semantics_final_if_choice_payload_nested_array_record_pointer_ternary_field_failure.or",
        slot_pointer_items_final_if_fixture_lines(
            "        Items([[Slot(flag ? raw_offset(base, 1) : raw_offset(other, 1))]])"
        ),
        8
    );
...
void test_final_if_choice_payload_nested_array_record_constructor_pointer_ternary_field_success() {
    assert_record_field_nested_array_context_success(
        "orison_semantics_final_if_choice_payload_nested_array_record_pointer_ternary_field_success.or",
        slot_pointer_items_final_if_success_fixture_lines(
            "        Items([[Slot(flag ? raw_offset(base, 1) : raw_offset(other, 1))]])"
        )
    );
}
...
void test_assignment_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_failure() {
    assert_record_field_nested_array_choice_context_failure(
        "orison_semantics_assignment_holder_choice_payload_nested_array_record_choice_ternary_field_failure.or",
        box_maybe_holder_items_assignment_fixture_lines(
...
void test_assignment_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_success() {
    assert_record_field_nested_array_context_success(
        "orison_semantics_assignment_holder_choice_payload_nested_array_record_choice_ternary_field_success.or",
        box_maybe_holder_items_assignment_fixture_lines(
...
void test_assignment_holder_choice_payload_nested_array_record_constructor_pointer_ternary_field_failure() {
    assert_record_field_nested_array_pointer_context_failure(
        "orison_semantics_assignment_holder_choice_payload_nested_array_record_pointer_ternary_field_failure.or",
        slot_pointer_holder_items_assignment_fixture_lines(
...
void test_assignment_holder_choice_payload_nested_array_record_constructor_pointer_ternary_field_success() {
    assert_record_field_nested_array_context_success(
        "orison_semantics_assignment_holder_choice_payload_nested_array_record_pointer_ternary_field_success.or",
        slot_pointer_holder_items_assignment_success_fixture_lines(
            "    holder = Holder(Items([[Slot(flag ? raw_offset(base, 1) : raw_offset(other, 1))]]))"
        )
    );
}

void test_return_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_failure() {
    assert_record_field_nested_array_choice_context_failure(
        "orison_semantics_return_holder_choice_payload_nested_array_record_choice_ternary_field_failure.or",
        box_maybe_holder_items_return_fixture_lines(
...
void test_return_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_success() {
    assert_record_field_nested_array_context_success(
        "orison_semantics_return_holder_choice_payload_nested_array_record_choice_ternary_field_success.or",
        box_maybe_holder_items_return_fixture_lines(
...
void test_final_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_failure() {
    assert_record_field_nested_array_choice_context_failure(
        "orison_semantics_final_holder_choice_payload_nested_array_record_choice_ternary_field_failure.or",
        box_maybe_holder_items_return_fixture_lines(
...
void test_final_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_success() {
    assert_record_field_nested_array_context_success(
        "orison_semantics_final_holder_choice_payload_nested_array_record_choice_ternary_field_success.or",
        box_maybe_holder_items_return_fixture_lines(
...
void test_return_holder_choice_payload_nested_array_record_constructor_pointer_ternary_field_failure() {
    assert_record_field_nested_array_pointer_context_failure(
        "orison_semantics_return_holder_choice_payload_nested_array_record_pointer_ternary_field_failure.or",
        slot_pointer_holder_items_return_fixture_lines(
...
void test_return_holder_choice_payload_nested_array_record_constructor_pointer_ternary_field_success() {
    assert_record_field_nested_array_context_success(
        "orison_semantics_return_holder_choice_payload_nested_array_record_pointer_ternary_field_success.or",
...
void test_final_holder_choice_payload_nested_array_record_constructor_pointer_ternary_field_failure() {
    assert_record_field_nested_array_pointer_context_failure(
        "orison_semantics_final_holder_choice_payload_nested_array_record_pointer_ternary_field_failure.or",
        slot_pointer_holder_items_return_fixture_lines(
...
void test_final_holder_choice_payload_nested_array_record_constructor_pointer_ternary_field_success() {
    assert_record_field_nested_array_context_success(
...
int main() {
    ...
    test_assignment_choice_payload_nested_array_record_constructor_choice_ternary_field_failure();
    ...
    test_final_if_choice_payload_nested_array_record_constructor_choice_ternary_field_failure();
    test_final_if_choice_payload_nested_array_record_constructor_choice_ternary_field_success();
    test_final_if_choice_payload_nested_array_record_constructor_pointer_ternary_field_failure();
    test_final_if_choice_payload_nested_array_record_constructor_pointer_ternary_field_success();
    ...
    test_assignment_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_failure();
    test_assignment_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_success();
    test_assignment_holder_choice_payload_nested_array_record_constructor_pointer_ternary_field_failure();
    test_assignment_holder_choice_payload_nested_array_record_constructor_pointer_ternary_field_success();
    test_return_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_failure();
    test_return_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_success();
    test_final_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_failure();
    test_final_holder_choice_payload_nested_array_record_constructor_choice_ternary_field_success();
    test_return_holder_choice_payload_nested_array_record_constructor_pointer_ternary_field_failure();
