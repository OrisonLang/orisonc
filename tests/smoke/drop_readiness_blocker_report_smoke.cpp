...
auto main() -> int {
    auto empty_summary = orison::lowering::summarize_owned_cleanup_readiness_blockers({});
    ...
    auto unresolved_summary = orison::lowering::summarize_owned_cleanup_readiness_blockers(unresolved_snapshot);
    ...
    auto authorized_summary = orison::lowering::summarize_owned_cleanup_readiness_blockers(authorized_snapshot);
