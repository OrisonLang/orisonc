...
named iteration, computed helper-returned View iteration, and method-returned View iteration.
...
| `view_descriptor_reads.or` | `shared.View<T>`/`exclusive.View<T>` descriptor length, checked index reads, exclusive indexed assignment, named iteration, computed helper-returned View iteration, and method-returned View iteration | backend |
