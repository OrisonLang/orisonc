...
named iteration, and computed helper-returned View iteration.
...
| `view_descriptor_reads.or` | `shared.View<T>`/`exclusive.View<T>` descriptor length, checked index reads, exclusive indexed assignment, named iteration, and computed helper-returned View iteration | backend |
