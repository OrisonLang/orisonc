...
- Audit branch-consumer ternary cleanup where the final consumer arms each allocate and forward independent scratch
  owners before returning the selected owner.
