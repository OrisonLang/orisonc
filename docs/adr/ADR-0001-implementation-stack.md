...
- Lowering context now also synthesizes monomorphized record layout entries for concrete generic record types
  ...
  concrete generic aggregate final-control including final `switch`, early-return, and loop-built paths, concrete generic receiver methods, method
  ...
  concrete generic constructor-array item shapes, while underconstrained nested generic constructor-array items retain
  generic inference diagnostics; uninstantiated
