...
- 2026-04-28: added loop-context validation for `break` and `continue`, so loop-control statements now fail semantically when they appear outside `while`, `repeat`, or `for` bodies.
