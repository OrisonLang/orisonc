...
- additional top-level forms and modifiers from the updated docs, including `foreign` blocks/exports, and `unsafe`/`async` function modifiers
...
- 2026-04-26: completed parser support for top-level constants, extended smoke coverage, and synchronized the parity records.
