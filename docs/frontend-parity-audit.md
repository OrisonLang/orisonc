...
- 2026-04-28: extended provenance propagation through same-origin ternary expressions, so conditional forwarding now preserves the same await/join/return structural checks instead of dropping back to an unclassified value.
