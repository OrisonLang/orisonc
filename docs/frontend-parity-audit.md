...
- 2026-04-28: extended structural provenance through `guard ... else` too, so failure-path assignments are analyzed for diagnostics but do not leak into the continuing path after the guard.
