...
- 2026-08-28: Shared production pipeline defaults now enable DynamicArray construction/index/append/cleanup gates.
  Source Drop lowering and computed `for` production gates remain separately controlled.
