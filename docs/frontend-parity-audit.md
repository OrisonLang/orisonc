...
- 2026-04-28: extended distinct local provenance handling into return sites and plain-name reassignment, so direct forwarding of thread/task/declared-async-call values now diagnoses earlier and rebinding preserves the same structural checks.
