...
- 2026-04-28: tightened constructor-pattern `switch` arm semantics again so unknown variant heads now also fail explicitly, in addition to the existing payload-shape, duplicate-binding, and arity checks.
