...
- 2026-04-28: added semantic `default` arm validation for `switch`, so mutated or otherwise malformed ASTs now reject multiple defaults and non-final defaults even beyond parser-time checks.
