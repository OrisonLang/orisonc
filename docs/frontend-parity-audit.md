...
- 2026-04-28: added switch-level pattern-kind consistency checks, so value switches and constructor-pattern switches can no longer mix arm kinds in the same statement.
