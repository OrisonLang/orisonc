...
- 2026-04-28: added receiver-context validation for `this` and `This`, so receiver-only identifiers now fail semantically outside `implements` and `extend` method contexts.
